...
public class GrassGenerator : MonoBehaviour {
    ...
    private void GenerateGrass(Vector3 startPosition, Vector3 patchSize, int grassCountPerPatch) {
        for (var i = 0; i < grassCountPerPatch; i++) {
            ...
            var currentPosition = new Vector3(startPosition.x + (randomizedXDistance),
                heightMap.GetPixel(indexX, indexZ).grayscale * (terrainHeight + 1),
